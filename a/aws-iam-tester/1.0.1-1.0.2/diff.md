# Comparing `tmp/aws_iam_tester-1.0.1.tar.gz` & `tmp/aws_iam_tester-1.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "aws_iam_tester-1.0.1.tar", max compression
+gzip compressed data, was "aws_iam_tester-1.0.2.tar", max compression
```

## Comparing `aws_iam_tester-1.0.1.tar` & `aws_iam_tester-1.0.2.tar`

### file list

```diff
@@ -1,10 +1,10 @@
--rw-r--r--   0        0        0     1069 2020-06-08 19:14:08.315887 aws_iam_tester-1.0.1/LICENSE
--rw-r--r--   0        0        0    11058 2022-05-16 11:38:15.732588 aws_iam_tester-1.0.1/README.md
--rw-r--r--   0        0        0      157 2021-03-04 11:59:21.240784 aws_iam_tester-1.0.1/aws_iam_tester/__init__.py
--rw-r--r--   0        0        0       27 2020-10-23 20:18:53.274166 aws_iam_tester-1.0.1/aws_iam_tester/__main__.py
--rwxr-xr-x   0        0        0     8494 2021-04-29 08:47:07.038228 aws_iam_tester-1.0.1/aws_iam_tester/cli.py
--rw-r--r--   0        0        0       40 2020-10-23 09:25:43.704372 aws_iam_tester-1.0.1/aws_iam_tester/lib/__init__.py
--rw-r--r--   0        0        0    30411 2022-12-09 08:12:00.858109 aws_iam_tester-1.0.1/aws_iam_tester/lib/aws_iam_tester.py
--rw-r--r--   0        0        0     1128 2022-12-09 14:11:59.778818 aws_iam_tester-1.0.1/pyproject.toml
--rw-r--r--   0        0        0    12419 1970-01-01 00:00:00.000000 aws_iam_tester-1.0.1/setup.py
--rw-r--r--   0        0        0    12266 1970-01-01 00:00:00.000000 aws_iam_tester-1.0.1/PKG-INFO
+-rw-r--r--   0        0        0     1069 2020-06-08 19:14:08.315887 aws_iam_tester-1.0.2/LICENSE
+-rw-r--r--   0        0        0    11058 2022-05-16 11:38:15.732588 aws_iam_tester-1.0.2/README.md
+-rw-r--r--   0        0        0      157 2021-03-04 11:59:21.240784 aws_iam_tester-1.0.2/aws_iam_tester/__init__.py
+-rw-r--r--   0        0        0       27 2020-10-23 20:18:53.274166 aws_iam_tester-1.0.2/aws_iam_tester/__main__.py
+-rwxr-xr-x   0        0        0     8494 2021-04-29 08:47:07.038228 aws_iam_tester-1.0.2/aws_iam_tester/cli.py
+-rw-r--r--   0        0        0       40 2020-10-23 09:25:43.704372 aws_iam_tester-1.0.2/aws_iam_tester/lib/__init__.py
+-rw-r--r--   0        0        0    30411 2022-12-09 08:12:00.858109 aws_iam_tester-1.0.2/aws_iam_tester/lib/aws_iam_tester.py
+-rw-r--r--   0        0        0     1128 2023-05-23 06:44:29.666108 aws_iam_tester-1.0.2/pyproject.toml
+-rw-r--r--   0        0        0    12419 1970-01-01 00:00:00.000000 aws_iam_tester-1.0.2/setup.py
+-rw-r--r--   0        0        0    12266 1970-01-01 00:00:00.000000 aws_iam_tester-1.0.2/PKG-INFO
```

### Comparing `aws_iam_tester-1.0.1/LICENSE` & `aws_iam_tester-1.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `aws_iam_tester-1.0.1/README.md` & `aws_iam_tester-1.0.2/README.md`

 * *Files identical despite different names*

### Comparing `aws_iam_tester-1.0.1/aws_iam_tester/cli.py` & `aws_iam_tester-1.0.2/aws_iam_tester/cli.py`

 * *Files identical despite different names*

### Comparing `aws_iam_tester-1.0.1/aws_iam_tester/lib/aws_iam_tester.py` & `aws_iam_tester-1.0.2/aws_iam_tester/lib/aws_iam_tester.py`

 * *Files identical despite different names*

### Comparing `aws_iam_tester-1.0.1/pyproject.toml` & `aws_iam_tester-1.0.2/pyproject.toml`
...
### Comparing `aws_iam_tester-1.0.1/setup.py` & `aws_iam_tester-1.0.2/setup.py`
...
### Comparing `aws_iam_tester-1.0.1/PKG-INFO` & `aws_iam_tester-1.0.2/PKG-INFO`
