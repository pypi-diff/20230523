# Comparing `tmp/pretext-1.5.4.dev20230521.tar.gz` & `tmp/pretext-1.5.4.dev20230522.tar.gz`
...
## Comparing `pretext-1.5.4.dev20230521.tar` & `pretext-1.5.4.dev20230522.tar`
...
### Comparing `pretext-1.5.4.dev20230521/LICENSE` & `pretext-1.5.4.dev20230522/LICENSE`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/README.md` & `pretext-1.5.4.dev20230522/README.md`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/__init__.py` & `pretext-1.5.4.dev20230522/pretext/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/build.py` & `pretext-1.5.4.dev20230522/pretext/build.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/cli.py` & `pretext-1.5.4.dev20230522/pretext/cli.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/codechat.py` & `pretext-1.5.4.dev20230522/pretext/codechat.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/config/xml_overlay.py` & `pretext-1.5.4.dev20230522/pretext/config/xml_overlay.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/core/pretext.py` & `pretext-1.5.4.dev20230522/pretext/core/pretext.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/core/resources.py` & `pretext-1.5.4.dev20230522/pretext/core/resources.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/core/resources.zip` & `pretext-1.5.4.dev20230522/pretext/core/resources.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/generate.py` & `pretext-1.5.4.dev20230522/pretext/generate.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/project.py` & `pretext-1.5.4.dev20230522/pretext/project.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/templates/__init__.py` & `pretext-1.5.4.dev20230522/pretext/templates/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/.gitignore` & `pretext-1.5.4.dev20230522/pretext/templates/resources/.gitignore`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/article.zip` & `pretext-1.5.4.dev20230522/pretext/templates/resources/article.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/book.zip` & `pretext-1.5.4.dev20230522/pretext/templates/resources/book.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/demo.zip` & `pretext-1.5.4.dev20230522/pretext/templates/resources/demo.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/devcontainer.json` & `pretext-1.5.4.dev20230522/pretext/templates/resources/devcontainer.json`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/hello.zip` & `pretext-1.5.4.dev20230522/pretext/templates/resources/hello.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/project.ptx` & `pretext-1.5.4.dev20230522/pretext/templates/resources/project.ptx`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pretext/templates/resources/slideshow.zip` & `pretext-1.5.4.dev20230522/pretext/templates/resources/slideshow.zip`
...
### Comparing `pretext-1.5.4.dev20230521/pretext/utils.py` & `pretext-1.5.4.dev20230522/pretext/utils.py`

 * *Files identical despite different names*

### Comparing `pretext-1.5.4.dev20230521/pyproject.toml` & `pretext-1.5.4.dev20230522/pyproject.toml`
...
### Comparing `pretext-1.5.4.dev20230521/PKG-INFO` & `pretext-1.5.4.dev20230522/PKG-INFO`
