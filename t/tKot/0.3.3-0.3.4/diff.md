# Comparing `tmp/tKot-0.3.3.tar.gz` & `tmp/tKot-0.3.4.tar.gz`
...
## Comparing `tKot-0.3.3.tar` & `tKot-0.3.4.tar`
...
### Comparing `tKot-0.3.3/pyproject.toml` & `tKot-0.3.4/pyproject.toml`
...
### Comparing `tKot-0.3.3/src/tKot/buttons.py` & `tKot-0.3.4/src/tKot/buttons.py`

 * *Files identical despite different names*

### Comparing `tKot-0.3.3/src/tKot/common.py` & `tKot-0.3.4/src/tKot/common.py`
...
### Comparing `tKot-0.3.3/src/tKot/frames.py` & `tKot-0.3.4/src/tKot/frames.py`
